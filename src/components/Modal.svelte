			...
			<div class="bg-white rounded-lg overflow-hidden shadow-xl p-6 px-14">
				...
				<div class="flex flex-col items-center justify-center">
					...
					<button
						...
						class="py-2 px-12 rounded-lg my-2 bg-indigo-600 text-white hover:bg-indigo-500 w-full"
						>Sounds good</button
					>
				</div>
			</div>
			...
			<div class="bg-white rounded-lg overflow-hidden shadow-xl p-6">
				...
				<div class="flex flex-col items-center justify-center">
					...
					<button
						...
						class="py-2 px-12 rounded-lg my-2 bg-indigo-600 text-white hover:bg-indigo-500"
						>Sigh..</button
					>
				</div>
			</div>
