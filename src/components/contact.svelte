<script>
	...
	let possibleNames = ["Carl Jung", "Ayn Rand", "Noam Chomsky", "Jane Goodall", "James Clear", "LUV NFT", "Kanye West", "Jermaine Cole", "Art Tatum", "Shigetora"]
	let possibleTopics = ["spiritual wealth", "AI tech", "tokenizing real estate", "web5 marketing", "spirituality", "5D gaming]", "the movie ready player one", "this website", "2023 memes", "the price of dentures", "unnecessary ice cream flavors"]
